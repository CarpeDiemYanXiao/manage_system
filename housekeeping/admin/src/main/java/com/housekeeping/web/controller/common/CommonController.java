package com.housekeeping.web.controller.common;
...
import com.housekeeping.framework.config.ServerConfig;
...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            String filePath = HousekeepingConfig.getDownloadPath() + fileName;
            ...
            throws Exception
    {
        try
        {
            ...
            // 本地资源路径
            String localPath = HousekeepingConfig.getProfile();
            // 数据库资源地址
