        ...
        <div class="header-container">
            <div class="header">
                <div class="header-left">
                    ...
                    <div class="titles" @click="router.push('/index/home')">家政服务网</div>
                </div>
                <div class="header-center">
                    <div class="front-header-nav">
                        <el-menu :default-active="route.path" mode="horizontal" :router="true">
                            <el-menu-item index="/index/home">首页</el-menu-item>
                            <el-menu-item index="/index/serve">全部服务</el-menu-item>
                            <el-menu-item index="/index/myBooking">我的预约</el-menu-item>
