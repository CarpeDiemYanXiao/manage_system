package com.housekeeping.framework.web.domain;

import java.net.UnknownHostException;
import java.util.LinkedList;
import java.util.List;
import java.util.Properties;
import com.housekeeping.common.utils.Arith;
import com.housekeeping.common.utils.ip.IpUtils;
import com.housekeeping.framework.web.domain.server.Cpu;
import com.housekeeping.framework.web.domain.server.Jvm;
import com.housekeeping.framework.web.domain.server.Mem;
import com.housekeeping.framework.web.domain.server.Sys;
import com.housekeeping.framework.web.domain.server.SysFile;
